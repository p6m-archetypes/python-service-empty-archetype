--- The p6m overlay standards (E1–E7), held against the Python "empty" archetype — a platform
...
local VARIANTS = {
  ...
  },
  {
    ...
    build_command = "pip install --no-cache-dir .",
...
prova.group("python-empty: the archetype itself", { tags = { "standards" } }, function(g)
