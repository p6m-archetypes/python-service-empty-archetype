-- Python Service Platform Overlay ("empty" archetype).
--
...
--
--   archetect render .../python-service-empty-archetype /path/to/existing-project
--
...
-- No Python package prompt: nothing the overlay renders (CI, Dockerfiles,
-- platform manifests) references a package name beyond project-name, so
